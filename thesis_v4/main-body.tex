...
The normalized fitness gain when dimensionality $N \rightarrow \infty$ follows 
...
&\overset{N \rightarrow \infty}{=} \sigma^* z_{\text{step},1}   - \frac{(\sigma^*)^2}{2 \mu}. \label{eqn:delta_surrogate}{}
\end{align}
