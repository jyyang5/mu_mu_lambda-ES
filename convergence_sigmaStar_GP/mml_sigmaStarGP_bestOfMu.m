% choose the best of mu offspings as parent after the GP training set is built 
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
function val = mml_sigmaStarGP_bestOfMu(f,x0,sigma_star,lambda,NUM_OF_ITERATIONS,TRAINING_FACTOR)
% initialization
