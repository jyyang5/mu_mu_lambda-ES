% CSA uses z = randn() in offspring genenration 

function val = mml_noise_csa_oneDimZ(f,x0,sigma0,sigma_star,sigma_ep_star,lambda,NUM_OF_ITERATIONS)
% initialization
