% Change strategy choose centroid best so far (similar to (1+1)-ES) 
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
function val = mml_GP_bestSoFar(f,x0,sigma0,lambda,NUM_OF_ITERATIONS)
% initialization
...
while((t < NUM_OF_ITERATIONS) && f_centroid > 10^(-8))
    ...
    % (mu/mu, lambda)-ES use GP estiate 
        ...
        xTrain(:, rem(t+35, 40)+1) = centroid_temp;                
        fTrain(rem(t+35, 40)+1) = f_centroid_temp;
