...
function val = fun_multiRun_strategy(f,mu,lambda,NUM_OF_RUNS,n,sigma0)
% initialization
% f:                  objective function value
% mu:                 population size
% lambda:             # of offsprings to generate in each iteration 
...
for i = 1:NUM_OF_RUNS
    ...
    x0 = randn(n,mu);
    % (mu/mu,lambda)-ES with GP
    a = mml_GP_bestSoFar(f,x0,sigma0,lambda,NUM_OF_ITERATIONS);
