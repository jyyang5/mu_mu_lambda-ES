...
if(typeDot == '.')
    ...
    plot(s_start:increment:s_end, sigma_counvergence_rate_array,':','Color','b','DisplayName',d); hold on; 
...
if LINE_OR_NOT==1
    ...
    % normalized same sacle for y axies
...
hold off
ylabel('normalized expected fitness gain \eta / \lambda','fontsize',20);
