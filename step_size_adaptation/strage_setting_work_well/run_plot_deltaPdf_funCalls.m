...
a = mml_GP_CSA_adapt(f,x0,sigma0,lambda,NUM_OF_ITERATIONS,TRAINING_SIZE,LENGTH_SCALE);
t = cell2mat(a(1));
...
semilogy([t_range1 t_range2], [fx_range1 fx_range2]);hold on;
...
GP_error_range2 = error_array(t_start+1:t);
