...
\end{cases}
\end{align}
where $\alpha=2^{1/N}$ resembles the rate of change for $\sigma$. A reasonable value for $\alpha$ is between $2^{1/N}$ and 2. 
...
\bottomrule  
\multicolumn{5}{c}{\footnotesize Note: the value shown for (1+1)-ES is its corresponding $\text{speed-up}_{\text{self}}$.}  
\end{tabular}
