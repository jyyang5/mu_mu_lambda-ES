...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% plot expected fitness gain for diffeent 
figure(FIG_NUM);
hold on;
...
if(n==10) 
    plot(v,max_sigma_array,':x','Color',scatterColour,'DisplayName',d1);
elseif(n==100)
    plot(v,max_sigma_array,':o','Color',scatterColour,'DisplayName',d1);
end
