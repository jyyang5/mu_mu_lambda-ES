...
function fun_fitness_sigmaStar(mu,lambda,ita,n,scatterColour,typeDot,LINE_OR_NOT)
%Input
...
if n ==10
    d = sprintf('v = %d', ita);
    text((s_start+s_end)/2-1, median(sigma_counvergence_rate_array), d, 'Color', scatterColour, 'fontsize',20);
end
