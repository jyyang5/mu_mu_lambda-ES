...
%            original
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
function val = fun_mergedGraph_fx_funCalls(f,name,NUM_OF_RUNS,sigma_star_array,lambda_array,theta,TRAINING_FACTOR,strategy_name)
%Input:
...
for i = 1:1:LAMBDA_LENGTH
    ...
    for j = 1:1:SIGMA_LENGTH
        ...
        for k = 1:NUM_OF_RUNS
            ...
            a = mml_sigmaStarGP_centroid_tuneTheta(f,x0,sigma_star_temp,lambda_temp,NUM_OF_ITERATIONS,TRAINING_FACTOR,theta);
