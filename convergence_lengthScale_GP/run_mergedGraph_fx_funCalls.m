...
TRAINING_FACTOR = 3;
theta = 2;
T_f11=fun_mergedGraph_fx_funCalls(f1,6,NUM_OF_RUNS,sigma_star_array,lambda_array,theta,TRAINING_FACTOR,strategy_name);
theta = 4;
T_f12=fun_mergedGraph_fx_funCalls(f1,6,NUM_OF_RUNS,sigma_star_array,lambda_array,theta,TRAINING_FACTOR,strategy_name);
theta = 8;
T_f13=fun_mergedGraph_fx_funCalls(f1,6,NUM_OF_RUNS,sigma_star_array,lambda_array,theta,TRAINING_FACTOR,strategy_name);
theta = 16;
T_f14=fun_mergedGraph_fx_funCalls(f1,6,NUM_OF_RUNS,sigma_star_array,lambda_array,theta,TRAINING_FACTOR,strategy_name);
theta = 32;
T_f15=fun_mergedGraph_fx_funCalls(f1,6,NUM_OF_RUNS,sigma_star_array,lambda_array,theta,TRAINING_FACTOR,strategy_name);
% % TRAINING_FACTOR = 4;
