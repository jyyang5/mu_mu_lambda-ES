...
\begin{center}
\begin{figure*}
\includegraphics[height=4.2in, width=6.2in]{merged_plot_v4}
...
To test the proposed the step size adaptation mechanism, we use same test functions and generate coresponding plots from Section 4.1. 
...
\textbf{Test functions} & \multicolumn{1}{c}{$(1+1)$-ES} & \multicolumn{1}{c}{$(3/3,10)$-ES} & \multicolumn{1}{c}{$(5/5,20)$-ES} & \multicolumn{1}{c}{$(10/10,40)$-ES}  \\
\midrule
\texttt{linear sphere} 	      &505  &364  &315  &322      \\
\texttt{quadratic sphere}     &214  &211  &162  &146    \\ 
\texttt{cubic sphere}         &203  &213  &177  &176    \\ 
\texttt{Schwefel\' s function}&1496 & +\infty &1352  & 1067\\
\texttt{quartic function}     &1244 &1509 &987&797    \\ 
\bottomrule             
\end{tabular}
