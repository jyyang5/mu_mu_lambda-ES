% plot step size, objective function value, normalized step size over iteration
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
function val = fun_graph_iterate_merged(f,name,NUM_OF_RUNS,mu,lambda)
%Input:
...
for i = 1:NUM_OF_RUNS
    ...
    hold on;
   % plot over number of iterations
    semilogy(1:T_max, sigma_med(1:T_max));           % mml with GP
    semilogy(1:T_max1, sigma_med1(1:T_max1));        % MML
    ...
    semilogy(1:T_max1, f_x_med1(1:T_max1));          % mml 
    ...
    if name == 6
       save('T_linear_sphere(iteration).mat','T_array','T_array1','T_array2','T_array3','f_x_med','f_x_med1','f_x_med2','f_x_med3','sigma_med','sigma_med1','sigma_med2','sigma_med3','sigma_star_med','sigma_star_med1','sigma_star_med2','sigma_star_med3','t','t1','t2','t3');
       saveas(gcf,'linear_sphere(iteration).fig');
    elseif name == 7
       ...
       saveas(gcf,'quadratic_sphere(iteration).fig');
    elseif name == 8
       save('T_cubic_sphere(iteration).mat','T_array','T_array1','T_array2','T_array3','f_x_med','f_x_med1','f_x_med2','f_x_med3','sigma_med','sigma_med1','sigma_med2','sigma_med3','sigma_star_med','sigma_star_med1','sigma_star_med2','sigma_star_med3','t','t1','t2','t3');
       saveas(gcf,'cubic_sphere(iteration).fig');
    elseif name == 9
       save('T_schwefel_function(iteration).mat','T_array','T_array1','T_array2','T_array3','f_x_med','f_x_med1','f_x_med2','f_x_med3','sigma_med','sigma_med1','sigma_med2','sigma_med3','sigma_star_med','sigma_star_med1','sigma_star_med2','sigma_star_med3','t','t1','t2','t3');
       saveas(gcf,'schwefel_function(iteration).fig');
    elseif name == 10
       save('T_quartic_function(iteration).mat','T_array','T_array1','T_array2','T_array3','f_x_med','f_x_med1','f_x_med2','f_x_med3','sigma_med','sigma_med1','sigma_med2','sigma_med3','sigma_star_med','sigma_star_med1','sigma_star_med2','sigma_star_med3','t','t1','t2','t3');
       saveas(gcf,'quartic_function(iteration).fig');
    end
