...
% Equivalent to below
% bar([T_med_f9(1,:)./T_med_f9(2,:),0; T_med_f9(1,:)./T_med_f9(3,:), T_med_f9(1,:)./T_med_f9(6,:);...
%     T_med_f9(1,:)./T_med_f9(4,:), T_med_f9(1,:)./T_med_f9(7,:); T_med_f9(1,:)./T_med_f9(5,:), T_med_f9(1,:)./T_med_f9(8,:); ]);hold on;
bar(repmat(T_med_f9(1,:),4,2)./[T_med_f9(2:5,:),[inf;T_med_f9(6:8,:)]]);
legend('\kappa = 1',sprintf('\\kappa = %d',kappa));
