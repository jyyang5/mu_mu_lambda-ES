...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Get # of runs that diverges
disp('-------------------------------------------------------------------F6');
disp([squeeze(sum(T_f6(1:2,:,:)==99999,3));squeeze(sum(T_f6(3:5,:,:)==9999,3))]);
disp('-------------------------------------------------------------------F7');
disp([squeeze(sum(T_f7(1:2,:,:)==99999,3));squeeze(sum(T_f7(3:5,:,:)==9999,3))]);
disp('-------------------------------------------------------------------F8');
disp([squeeze(sum(T_f8(1:2,:,:)==99999,3));squeeze(sum(T_f8(3:5,:,:)==9999,3))]);
disp('-------------------------------------------------------------------F9');
disp([squeeze(sum(T_f9(1:2,:,:)==99999,3));squeeze(sum(T_f9(3:5,:,:)==9999,3))]);
