...
%            
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
function val = fun_multi_run_change_success_rate_FUNCALLS(fname,NUM_OF_RUNS,lambda,TRAINING_SIZE,LENGTH_SCALE,SIGMA_STAR_array,FIGURE_NUM,subplot_ROW,subplot_COL,str_cell_SIGMA_STAR)
%Input:
%   fname:          an index 
%                       1 for linear
%                       2 for quadratic 
...
for q = 1:1:length(SIGMA_STAR_array)
    ...
    d = sprintf('(%d/%d,%d)-ES,\\sigma^*=%.1f',mu,mu,lambda,SIGMA_STAR);
...
% legend('show');
    ...
    xlabel('Normalized step size','FontSize',15); 
