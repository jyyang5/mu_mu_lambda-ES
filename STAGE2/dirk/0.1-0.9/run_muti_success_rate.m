...
for i=1:1:length(lambda_array)
	...
	FIGURE_NUM = i;
    for fname = 1:1:5
        temp = fun_multi_run_change_success_rate_FUNCALLS(fname,NUM_OF_RUNS,lambda,TRAINING_SIZE,LENGTH_SCALE,PROB_RATE_array,S1,FIGURE_NUM,subplot_ROW,subplot_COL,str_cell_PROB_RATE);         
