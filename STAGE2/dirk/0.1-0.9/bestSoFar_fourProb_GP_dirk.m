...
% Compute 4 probs
fep_y_array = zeros(1,10000);   % predicted function value of offspring 
f_y_array = zeros(1,10000);     % true function value of offspring 
f_x_array = zeros(1,10000);     % true function value of parent 
