...
SUCCESS_RATIO_array = 0.6:0.1:0.8;
...
for j=1:1:length(SUCCESS_RATIO_array)
    ...
    for fname = 1:1:5
        for i = 1:1:length(lambda_array)
            ...
            temp = fun_multi_run_change_success_rate_ITERATION(fname,NUM_OF_RUNS,lambda,TRAINING_SIZE,LENGTH_SCALE,SUCCESS_RATE,FIGURE_NUM,subplot_ROW,subplot_COL,i);         
