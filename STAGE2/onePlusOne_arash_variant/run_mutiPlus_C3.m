...
for i=1:1:length(lambda_array)
	...
	FIGURE_NUM = i;
    for fname = 1:1:5
        temp = fun_multiPlus_change_C3_FUNCALLS(fname,NUM_OF_RUNS,lambda,TRAINING_SIZE,LENGTH_SCALE,C1,C2,PROB_array,FIGURE_NUM,subplot_ROW,subplot_COL,str_cell_PROB_RATE);
