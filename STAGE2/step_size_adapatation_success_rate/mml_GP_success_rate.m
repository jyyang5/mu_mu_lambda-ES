% Using success rate to update step size and GP model 
...
function val = mml_GP_success_rate(fname,x0,sigma0,lambda,NUM_OF_ITERATIONS,TRAINING_SIZE,LENGTH_SCALE)
% initialization
% fname:              an index 
%                       1 for linear
%                       2 for quadratic 
