...
%     else 
    x0 = randn(n,mu);
    a = mml_GP_success_rate(fname,x0,sigma0,lambda,NUM_OF_ITERATIONS,TRAINING_SIZE,LENGTH_SCALE,DECREASE_FACTOR);
...
saveas(gcf,'merged_plot_emergency_v2.fig'); 
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    legend('-DynamicLegend'); 
    legend('show');
    saveas(gcf,'success_emergency_v2.fig'); 
