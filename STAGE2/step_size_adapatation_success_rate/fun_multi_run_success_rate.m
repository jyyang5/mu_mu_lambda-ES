...
%            
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
function val = fun_multi_run_success_rate(fname,NUM_OF_RUNS,lambda,TRAINING_SIZE,LENGTH_SCALE,FIGURE_NUM,subplot_ROW,subplot_COL)
%Input:
%   fname:          an index 
%                       1 for linear
%                       2 for quadratic 
...
%    SIGMA_STAR     normalized step size used to update step size
% 
%Return:
% 	1.t_array
%   2.sigma_matrix
...
for i = 1:NUM_OF_RUNS
    x0 = randn(n,mu);
    sigma0 = 1;
    a = mml_GP_success_rate(fname,x0,sigma0,lambda,NUM_OF_ITERATIONS,TRAINING_SIZE,LENGTH_SCALE);
...
saveas(gcf,'merged_plot_success_rate.fig'); 
