% [Refactored] training (1+1)-ES + after cross-ES (one objFunCall/iteration)
...
function val = onePlusOne_fourProb_GP_cross(fname,x0,sigma0,lambda,NUM_OF_ITERATIONS,TRAINING_SIZE,LENGTH_SCALE,S)
% initialization
% fname:              an index 
%                       1 for linear
%                       2 for quadratic 
