% Using normalized step size and GP model 
...
function val = mml_GP_SIGMA_STAR(fname,x0,SIGMA_STAR,lambda,NUM_OF_ITERATIONS,TRAINING_SIZE,LENGTH_SCALE)
% initialization
% fname:              an index 
%                       1 for linear
%                       2 for quadratic 
...
%         val = {9999,mean(x0, 2),9999,sigma_array, 9999, fcentroid_array,-1,error_array,sigma_star_array,success_rate,delta_array}; 
        val = {t,centroid,f_centroid,sigma_array, 99999, fcentroid_array,convergence_rate,error_array,sigma_star_array,0,delta_array};
