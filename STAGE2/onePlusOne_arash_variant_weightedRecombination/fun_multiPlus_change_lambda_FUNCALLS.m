...
%            
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
function val = fun_multiPlus_change_lambda_FUNCALLS(fname,NUM_OF_RUNS,lambda_array,TRAINING_SIZE,LENGTH_SCALE,SUCCESS_RATE,DF,C3,FIGURE_NUM,subplot_ROW,subplot_COL,str_cell_SIGMA_STAR)
%Input:
%   fname:          an index 
%                       1 for linear
%                       2 for quadratic 
