% [Refactored] training (1+1)-ES + after [bestSoFar]
...
function val = bestSoFar_fourProb_GP_arashVariant(fname,x0,sigma0,lambda,NUM_OF_ITERATIONS,TRAINING_SIZE,LENGTH_SCALE,C1,C2,C3)
% initialization
% fname:              an index 
%                       1 for linear
%                       2 for quadratic 
