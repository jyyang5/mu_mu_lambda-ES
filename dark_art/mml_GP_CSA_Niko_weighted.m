% Using Niko's CSA(paper CMA tutorial) use weighted recombination
...
function val = mml_GP_CSA_Niko_weighted(fname,x0,sigma0,lambda,NUM_OF_ITERATIONS,TRAINING_SIZE,LENGTH_SCALE,DECREASE_FACTOR)
% initialization
