...
%            save file
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
function val = fun_multi_over_lambda(fname,NUM_OF_RUNS,lambda_array,TRAINING_SIZE,LENGTH_SCALE)
%Input:
...
for i=1:1:LAMBDA_LENGTH
    ...
    for j = 1:NUM_OF_RUNS
        ...
        % (mu/mu,lambda)-ES with GP
        a = mml_GP_CSA_Niko(fname,x0,sigma0,lambda_temp,NUM_OF_ITERATIONS,TRAINING_SIZE,LENGTH_SCALE);
...
% plot by taking the mean of relative model error in median run
    ...
    elseif fname == 4 
        d3 = sprintf('schwefel_modelError_lambd.fig');
    elseif fname == 5
        d3 = sprintf('quartic_modelError_lambd.fig');
    end
    saveas(gcf,d3);
