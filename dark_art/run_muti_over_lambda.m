...
fname = 1;
temp1 = fun_multi_over_lambda(fname,NUM_OF_RUNS,lambda_array,TRAINING_SIZE,LENGTH_SCALE);

fname = 2;
temp2 = fun_multi_over_lambda(fname,NUM_OF_RUNS,lambda_array,TRAINING_SIZE,LENGTH_SCALE);

fname = 3;
temp3 = fun_multi_over_lambda(fname,NUM_OF_RUNS,lambda_array,TRAINING_SIZE,LENGTH_SCALE);

fname = 4;
temp4 = fun_multi_over_lambda(fname,NUM_OF_RUNS,lambda_array,TRAINING_SIZE,LENGTH_SCALE);

fname = 5;
temp5 = fun_multi_over_lambda(fname,NUM_OF_RUNS,lambda_array,TRAINING_SIZE,LENGTH_SCALE);
