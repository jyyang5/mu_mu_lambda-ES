...
for fname = 1:1:5
    for i = 1:1:length(lambda_array)
        ...
        temp = fun_multi_run_NO_emergency(fname,NUM_OF_RUNS,lambda,TRAINING_SIZE,LENGTH_SCALE,DECREASE_FACTOR,FIGURE_NUM);
...
save('data_NO_emergency.mat','NUM_OF_RUNS','TRAINING_SIZE','LENGTH_SCALE','DECREASE_FACTOR',...
