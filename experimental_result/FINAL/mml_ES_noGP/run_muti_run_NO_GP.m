...
for fname = 1:1:5
    for i = 1:1:length(lambda_array)
        ...
        temp = fun_multi_run_NO_GP(fname,NUM_OF_RUNS,lambda,TRAINING_SIZE,LENGTH_SCALE,DECREASE_FACTOR,FIGURE_NUM);
...
save('data_NO_GP.mat','NUM_OF_RUNS',...
    't_array','sigma_matrix','T_array','f_x_matrix','convergence_rate_array',...
    'sigma_star_matrix','success_rate_array');
