...
if(T_med == 5000) % early stopping
    h2 = histogram(zeros(t_med,1)-1,'Normalization','probability','DisplayName',d);hold on;
else
    h2 = histogram(delta_matrix,'Normalization','probability','DisplayName',d);hold on;
end
% if(lambda==0)
...
% % No bar colour, bold binwidth
% if(T_med == 5000) % early stopping
%     h2 = histogram(zeros(t_med,1)-1,'Normalization','probability','DisplayName',d,'FaceColor','none','LineWidth',2);hold on;
% else
%     h2 = histogram(delta_matrix,'Normalization','probability','DisplayName',d,'FaceColor','none','LineWidth',2);hold on;
% end
% if(lambda==0)
%     h2.BinEdges=h.BinEdges-0.0125;
% elseif(lambda == 10)
...
% % No bar colour, bold binwidth
% if(T_med == 5000) % early stopping
%     h2 = histogram(zeros(t_med)-1,'Normalization','probability','DisplayName');hold on;
% else
%     h2 = histogram(success_rate_array,'Normalization','probability','DisplayName');hold on;
% end
% % if(lambda==0)
% %     h2.BinEdges=h.BinEdges-0.0125;
% % elseif(lambda == 10)
