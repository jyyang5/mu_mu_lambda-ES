...
%            save file
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
function val = fun_multi_run(f,name,NUM_OF_RUNS,lambda_array,TRAINING_SIZE,LENGTH_SCALE)
%Input:
%       f:           
...
for j=1:1:LAMBDA_LENGTH
    ...
    for j = 1:NUM_OF_RUNS
        ...
        % (mu/mu,lambda)-ES with GP
        a = mml_GP_CSA(f,x0,sigma0,lambda_temp,NUM_OF_ITERATIONS,TRAINING_SIZE);
