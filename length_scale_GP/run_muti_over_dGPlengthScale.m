...
subplot(2,2,1)
hold on;
plot(LENGTH_SCALE_array,cell2mat(temp1(1)));hold on;
plot(LENGTH_SCALE_array,cell2mat(temp2(1)));hold on;
plot(LENGTH_SCALE_array,cell2mat(temp3(1)));hold on;
plot(LENGTH_SCALE_array,cell2mat(temp4(1)));hold on;
plot(LENGTH_SCALE_array,cell2mat(temp5(1)));hold on;
...
subplot(2,2,2)
hold on;
plot(LENGTH_SCALE_array,cell2mat(temp1(6)));hold on;
plot(LENGTH_SCALE_array,cell2mat(temp2(6)));hold on;
plot(LENGTH_SCALE_array,cell2mat(temp3(6)));hold on;
plot(LENGTH_SCALE_array,cell2mat(temp4(6)));hold on;
plot(LENGTH_SCALE_array,cell2mat(temp5(6)));hold on;
xlabel('DECREASE FATOR (when inferior offspring)','fontsize',15);
...
subplot(2,2,3)
hold on;
plot(LENGTH_SCALE_array,cell2mat(temp1(2)));hold on;
plot(LENGTH_SCALE_array,cell2mat(temp2(2)));hold on;
plot(LENGTH_SCALE_array,cell2mat(temp3(2)));hold on;
plot(LENGTH_SCALE_array,cell2mat(temp4(2)));hold on;
plot(LENGTH_SCALE_array,cell2mat(temp5(2)));hold on;
xlabel('DECREASE FATOR (when inferior offspring)','fontsize',15);
...
subplot(2,2,4)
hold on;
plot(LENGTH_SCALE_array,cell2mat(temp1(3)));hold on;
plot(LENGTH_SCALE_array,cell2mat(temp2(3)));hold on;
plot(LENGTH_SCALE_array,cell2mat(temp3(3)));hold on;
plot(LENGTH_SCALE_array,cell2mat(temp4(3)));hold on;
plot(LENGTH_SCALE_array,cell2mat(temp5(3)));hold on;
xlabel('DECREASE FATOR (when inferior offspring)','fontsize',15);
